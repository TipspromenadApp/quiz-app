        ...
        public byte[] GenerateQuizResultPdf(QuizResult result)
        {
            var document = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    // Footer
                    page.Footer().AlignCenter().Text("Generated by Quiz Explorers – Bringing Knowledge to Life");
            ...
            {
                Title    = $"Quiz Result – {result.UserName}",
                Author   = result.UserName,                 // this replaces "Anonymous"
                Creator  = "Generated by Quiz Explorers – Bringing Knowledge to Life",
                Subject  = "Quiz Results",
                Keywords = "quiz, results, learning"
            };
